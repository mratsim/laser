...
type
  MatrixView*[T] = object
    ...
    nrows*, ncols*: int         # rows, columns
    incRow*, incCol*: int # strides
...
template `[]`*[T](view: MatrixView[T], row, col: int): T =
  ...
  view.buffer[row * view.incRow + col * view.incCol]
